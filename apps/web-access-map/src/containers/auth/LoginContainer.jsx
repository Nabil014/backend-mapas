  ...
  return (
    <div className='flex flex-col-reverse justify-center items-center gap-80 h-screen font-poppi   md:flex-row'>
      <div className='justify-center items-center h-44 md:w-screen md:items-stretch md:basis-1/2 lg:basis-1/2'>
        <h1 className='text-blue-400 -mt-[110%] text-5xl text-center -ml-[7.6%]  md:-mt-[37%] md:mb-7 md:ml-[50%] md:text-6xl lg:text-7xl lg:mr-[60] 2xl:ml-[45%]'>AccesMap</h1>
        <section className='basi justify-center items-center p-5 ml-[15.5%] text-2xl w-[80%]  md:w-[130%] md:ml-[52%] md:self-center lg:ml-[36%] 2xl:ml-[14.4%]'>
